"""
Generate Sphinx Age Myth Video

Story: Is the Sphinx 12,000 Years Old?
Style: Cinematic Epic (Hollywood documentary)
Series: History Myths #3
"""
...
async def generate_sphinx_video():
    """Generate the complete Sphinx age myth video."""
    
    output_dir = Path("outputs/shorts/history-myths_sphinx-age")
    bg_dir = output_dir / "backgrounds"
    bg_dir.mkdir(parents=True, exist_ok=True)
    
    print("=" * 60)
    print("SPHINX AGE MYTH VIDEO GENERATION")
    print("=" * 60)
    ...
    # =========================================================================
    print("\n" + "=" * 60)
    print("PHASE 1: IMAGE GENERATION (Cinematic Style)")
    print("=" * 60)
    ...
    for i, p in enumerate(prompts):
        ...
        result = await provider.generate_image(
            ...
            fallback_keyword=p.get("fallback_keyword", "sphinx egypt"),
            aspect_ratio="9:16",
    ...
    if final_path.exists():
        ...
        print(f"Series: History Myths #3")
    ...
    # Save metadata
    metadata = {
        "topic": "Sphinx Age Controversy",
        "series": {
            "name": "History Myths",
            "episode": 3,
            "display": "History Myths #3"
        },
        "duration": duration,
        "style": "cinematic",
...
if __name__ == "__main__":
    asyncio.run(generate_sphinx_video())
